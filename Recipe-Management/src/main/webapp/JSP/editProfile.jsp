...
${error }
<%
List<User> datalist = (List<User>)request.getAttribute("userdata");
		for(int l = 0; l < datalist.size(); l++){
%>
  <div class="row align-items-center" style="margin-left:90px ">
    <div class="col">
     Id : <%out.print(datalist.get(l).getId()); %> <br> <br>
     Username : <%out.print(datalist.get(l).getUsername()); %> <br> <br>
     Email : <%out.print(datalist.get(l).getEmail()); %><br> <br>
     <%} %>
    </div>
