...
<html lang="en">
    ...
    <%@page import ="com.operation.Model.Recipes"%>
<head>
    <meta charset="UTF-8" />
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Users Recipes</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
                                    <th scope="col" width="50">ID of users</th>
                                     <th scope="col">Recipe Name</th>
                                    <th scope="col">Vegetables</th>
                                    <th scope="col">Spices and Herbs</th>
                            ...
                            <tbody>
                            <%
							List<Recipes> dataList = (List<Recipes>)session.getAttribute("data");
							for(int i = 0; i<dataList.size(); i++){
	
							%>
                                <tr>
                                    <th scope="row"><%out.print(dataList.get(i).getCp_fk()); %></th>
